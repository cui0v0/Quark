 ...
 *
 * This class is implemented on {@link net.minecraft.world.item.trading.MerchantOffer} via {@link org.violetmoon.quark.mixin.MerchantOfferMixin}.
 * Therefore, an offer can be cast to this interface, and subsequently use the interface methods implemented in the mixin.
 *
