...
public class SectionScreen extends AbstractQScreen {
	...
	protected ScrollableWidgetList2<SectionScreen, SectionScreen.Entry> list;
	...
	protected void init() {
		...
		this.list = new ScrollableWidgetList2<>(this);
	...
	public abstract static class Entry extends ScrollableWidgetList2.Entry<Entry> { }
	...
	public class DefinitionEntry<T extends Definition> extends Entry {
		...
		public DefinitionEntry(ChangeSet changes, T def) {
			...
			ext.addWidgets(SectionScreen.this, changes, def, children);
		}
