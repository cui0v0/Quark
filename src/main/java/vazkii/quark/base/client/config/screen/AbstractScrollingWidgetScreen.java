...
public abstract class AbstractScrollingWidgetScreen extends AbstractQScreen {
	...
	protected void init() {
		...
		addRenderableWidget(new Button2(left, vStart, bWidth, 20, Component.translatable("quark.gui.config.default"), this::onClickDefault));
		addRenderableWidget(resetButton = new Button2(left + bWidth + pad, vStart, bWidth, 20, Component.translatable("quark.gui.config.discard"), this::onClickDiscard));
		addRenderableWidget(new Button2(left + (bWidth + pad) * 2, vStart, bWidth, 20, Component.translatable("gui.done"), this::onClickDone));
