...
public class DataMaintainingSmokingRecipe extends SmokingRecipe {
	...
	public static class Serializer implements RecipeSerializer<DataMaintainingSmokingRecipe> {
		...
		@Nonnull
		@Override
		public DataMaintainingSmokingRecipe fromJson(@Nonnull ResourceLocation recipeId, @Nonnull JsonObject json) {
		...
		@Nonnull
		@Override
		public DataMaintainingSmokingRecipe fromNetwork(@Nonnull ResourceLocation recipeId, @Nonnull FriendlyByteBuf buffer) {
		...
		public void toNetwork(@Nonnull FriendlyByteBuf buffer, @Nonnull DataMaintainingSmokingRecipe recipe) {
