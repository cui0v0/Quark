...
public class BooleanClientDefinition implements ClientDefinitionExt<ValueDefinition<Boolean>> {
	...
	@Override
	public void addWidgets(SectionScreen parent, ChangeSet changes, ValueDefinition<Boolean> def, List<WidgetWrapper> widgets) {
		widgets.add(new WidgetWrapper(new CheckboxButton(230, 3, def, changes)));
	}
}
